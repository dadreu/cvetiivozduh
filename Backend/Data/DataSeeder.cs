        ...
        if (!await context.Flowers.AnyAsync())
        {
            ...
            if (category != null)
            {
                context.Flowers.AddRange(
                    ...
                    new Flower { Name = "Нежная зефирка", Description = "Цветы и Воздух", Price = 2950, ImageUrl = "/catalog/softy.jpg", CategoryId = category.Id },
                    ...
                    new Flower { Name = "Ароматные лилии", Description = "Цветы и Воздух", Price = 3650, ImageUrl = "/catalog/Lylyi.jpg", CategoryId = category.Id },
                    ...
                    new Flower { Name = "Букет БАНТ 🌸", Description = "Цветы и Воздух", Price = 3000, ImageUrl = "/catalog/bant.jpg", CategoryId = category.Id },
